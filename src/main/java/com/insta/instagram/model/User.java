...
public class User {
    ...
    public User(Integer id, String username, String name, String email, String mobileNumber, String website, String bio, String gender, String image, String password, Set<UserDTO> follower, Set<UserDTO> following, List<Story> stories, List<Post> savedPost) {
        this.id = id;
